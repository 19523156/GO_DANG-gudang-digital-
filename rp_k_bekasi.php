...
<head>
	...
	<link rel="stylesheet" type="text/css" href="rp_k_bekasi.css">
...
<body>
	...
	<nav class="sidebar">
		...
		<ul>
			<li><a href="dashboard.php">Riwayat Penyewaan</a></li>
			<li>
	...
	<div class="dashboard">
		<h1>Riwayat Penyewaan Gudang</h1>
		<h2>Bekasi</h2>
		<td>
			...
			<tr>
				<form>
					...
					<input type="text" name="jeng1" value="Kemeja">
					<label>Slot</label>
					<input type="text" name="slotg1" value="1000m2">
					<label>Durasi</label>
					<input type="text" name="deskg1" value="12 Bulan">
					<label>Biaya Penyewaan</label>
					<input type="text" name="biag1" value="IDR 15.000.000">
					<label>Kode Pemesanan</label>
					<input type="text" name="kod" value="152289886772877667">
				</form>
			</tr>
		</td>
	</div>
