...
<head>
	...
	<link rel="stylesheet" type="text/css" href="basah.css">
...
<body>
	...
	<nav class="sidebar">
		...
		<ul>
			<li><a href="dashboard.php">Gudang Basah</a></li>
			<li>
	...
	<div class="dashboard">
		<h1>Daftar Gudang Basah</h1>
		<table>
			<tr>
				<td>
					<img src="gudang7.jpg" class="g1">
					<a href="dashboard.php" class="a1">Bandung</a>
				</td>
				<td>
					<img src="gudang2.jpg" class="g1">
					<a href="" class="a2">Jakarta Pusat</a>
				</td>
				<td>
				...
				<td>
					...
					<a href="" class="a1">Lampung</a>
				</td>
			</tr>
			<tr>
				<td>
					<img src="gudang5.jpg" class="g1">
					<a href="" class="a4">Kudus</a>
				</td>
				<td>
					<img src="gudang6.jpeg" class="g1">
					<a href="" class="a5">Surabaya</a>
				</td>
				<td>
					<img src="gudang7.jpg" class="g1">
